                        ...
                        <div class="flight-booking-wrapper">
                            ...
                            <div class="flight-booking-price">
                                ...
                                <a target="_blank"
                                    ...
                                    class="theme-btn">Book Now<i class="far fa-arrow-right"></i></a>
                                @endif
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="flight-booking-detail-right">
                                                <ul class="nav nav-tabs" id="frTab1" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link active" id="fr-tab1"
                                                            data-bs-toggle="tab" data-bs-target="#fr-tab-pane1"
                                                            type="button" role="tab" aria-controls="fr-tab-pane1"
                                                            aria-selected="true">Baggage</button>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link" id="fr-tab2" data-bs-toggle="tab"
                                                            data-bs-target="#fr-tab-pane2" type="button" role="tab"
                                                            aria-controls="fr-tab-pane2"
                                                            aria-selected="false">Fare</button>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link" id="fr-tab3" data-bs-toggle="tab"
                                                            data-bs-target="#fr-tab-pane3" type="button" role="tab"
                                                ...
                                                <div class="tab-content" id="frTabContent1">
                                                    <div class="tab-pane  show active" id="fr-tab-pane1"
                                                        ...
                                                        <div class="flight-booking-detail-info">
                                                            <table class="table table-borderless">
                                                                ...
                                                                <tr>
                                                                    <td>{{ $trip->airport_from_name }} -
                                                                        {{ $trip->airport_to_name }}</td>
                                                    ...
                                                    <div class="tab-pane " id="fr-tab-pane2" role="tabpanel"
                                                    ...
                                                    <div class="tab-pane " id="fr-tab-pane3" role="tabpanel"
                                                        aria-labelledby="fr-tab3" tabindex="0">
                                                        <div class="flight-booking-detail-info">
